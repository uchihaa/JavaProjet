...
public class Main {
	 ...
	 public static void main(String[] args){
		...
		Avion a2 = new Avion("55", "gaou2", true);
		Horaire h2 = new Horaire(15, 00);
		Etat e2 = null;
		Vol v2 = new Vol("666", a2, "Toulouse", h2, e2);
		 
		Sejour s1 = new Sejour(v1,v2);
		parking16.ajoutSejour(s1);
		TrancheHoraire TH = new TrancheHoraire(h1, h2);
		 
		ArrayList res = null;
		res = zoneV.parkingLibre(TH);
